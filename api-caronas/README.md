...
| `validarDocumento` | — | — | Middleware pós-upload: valida magic bytes de PDF (`%PDF` = `0x25 0x50 0x44 0x46`) |
...
- **`removerPenalidade`** — seta `pen_ativo = 0`. Se o tipo for 4, consulta veículos ativos do usuário e restaura `usu_verificacao` para `2` (com veículo) ou `1` (sem veículo), garantindo que o nível correto seja restaurado.
